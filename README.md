...
> [plivo-java-3.1.0-jar-with-dependencies.jar](http://helpers.plivo.com/java/plivo-java-3.1.0-jar-with-dependencies.jar) <br/>
...
> [plivo-java-3.1.0.jar](http://helpers.plivo.com/java/plivo-java-3.1.0.jar) <br />
